/* ===== [dbo].[tr_Audit_BJSortirRejectOutputLabelReject] ON [dbo].[BJSortirRejectOutputLabelReject] ===== */
-- =============================================
-- TRIGGER: tr_Audit_BJSortirRejectOutputLabelReject
...
-- =============================================
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_BJSortirRejectOutputLabelReject]
ON [dbo].[BJSortirRejectOutputLabelReject]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
    ...
    SELECT
      ...
      (
        SELECT
          ...
          i.NoReject
        FROM inserted i
        ORDER BY i.NoReject, i.NoBJSortir
        FOR JSON PATH
      );
  END
    ...
    SELECT
      ...
      (
        SELECT
          ...
          d.NoReject
        FROM deleted d
        ORDER BY d.NoReject, d.NoBJSortir
        FOR JSON PATH
      ),
      NULL;
  END
