/* ===== [dbo].[tr_Audit_BrokerProduksiInputBB] ON [dbo].[BrokerProduksiInputBB] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_BrokerProduksiInputBB]
ON [dbo].[BrokerProduksiInputBB]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
  ...
  /* ======================================================
     ...
     1 row per (NoProduksi, NoBahanBaku, NoPallet)
     (Kalau update jarang, ini tetap aman)
  ====================================================== */
