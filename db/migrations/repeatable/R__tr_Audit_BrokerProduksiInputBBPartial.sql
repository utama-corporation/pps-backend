/* ===== [dbo].[tr_Audit_BrokerProduksiInputBBPartial] ON [dbo].[BrokerProduksiInputBBPartial] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_BrokerProduksiInputBBPartial]
ON [dbo].[BrokerProduksiInputBBPartial]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
