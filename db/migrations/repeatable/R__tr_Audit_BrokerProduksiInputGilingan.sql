/* ===== [dbo].[tr_Audit_BrokerProduksiInputGilingan] ON [dbo].[BrokerProduksiInputGilingan] =====
   ...
   NewData/OldData: array of {NoProduksi, NoGilingan, Berat, IsPartial}
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_BrokerProduksiInputGilingan]
ON [dbo].[BrokerProduksiInputGilingan]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
  ...
  SELECT
    ...
    (
      ...
      WHERE x.NoProduksi = gg.NoProduksi AND x.NoGilingan = gg.NoGilingan
      FOR JSON PATH
    )
  FROM g gg;
  ...
  BEGIN
    ...
    SELECT
      ...
      (
        ...
        WHERE d.NoProduksi = gg.NoProduksi AND d.NoGilingan = gg.NoGilingan
        FOR JSON PATH
      ),
      ...
      (
        ...
        WHERE i.NoProduksi = gg.NoProduksi AND i.NoGilingan = gg.NoGilingan
        FOR JSON PATH
      )
    FROM g gg;
  END
