/* ===== [dbo].[tr_Audit_BrokerProduksiInputGilinganPartial] ON [dbo].[BrokerProduksiInputGilinganPartial] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_BrokerProduksiInputGilinganPartial]
ON [dbo].[BrokerProduksiInputGilinganPartial]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
