/* ===== [dbo].[tr_Audit_BrokerProduksiInputMixer] ON [dbo].[BrokerProduksiInputMixer] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_BrokerProduksiInputMixer]
ON [dbo].[BrokerProduksiInputMixer]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
  ...
  SELECT
    ...
    (
      ...
      WHERE x.NoProduksi = gg.NoProduksi AND x.NoMixer = gg.NoMixer
      ORDER BY x.NoSak
      FOR JSON PATH
    )
  FROM g gg;
  ...
  BEGIN
    ...
    SELECT
      ...
      (
        ...
        WHERE d.NoProduksi = gg.NoProduksi AND d.NoMixer = gg.NoMixer
        ORDER BY d.NoSak
        FOR JSON PATH
      ),
      ...
      (
        ...
        WHERE i.NoProduksi = gg.NoProduksi AND i.NoMixer = gg.NoMixer
        ORDER BY i.NoSak
        FOR JSON PATH
      )
    FROM g gg;
