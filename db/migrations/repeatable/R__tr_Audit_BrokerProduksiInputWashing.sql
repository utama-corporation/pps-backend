/* ===== [dbo].[tr_Audit_BrokerProduksiInputWashing] ON [dbo].[BrokerProduksiInputWashing] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_BrokerProduksiInputWashing]
ON [dbo].[BrokerProduksiInputWashing]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
  ...
  SELECT
    ...
    (
      ...
      WHERE x.NoProduksi = gg.NoProduksi AND x.NoWashing = gg.NoWashing
      ORDER BY x.NoSak
      FOR JSON PATH
    )
  FROM g gg;
  ...
  BEGIN
    ...
    SELECT
      ...
      (
        ...
        WHERE d.NoProduksi = gg.NoProduksi AND d.NoWashing = gg.NoWashing
        ORDER BY d.NoSak
        FOR JSON PATH
      ),
      ...
      (
        ...
        WHERE i.NoProduksi = gg.NoProduksi AND i.NoWashing = gg.NoWashing
        ORDER BY i.NoSak
        FOR JSON PATH
      )
    FROM g gg;
