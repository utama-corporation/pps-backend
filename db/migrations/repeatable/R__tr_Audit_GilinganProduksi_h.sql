...
/* ===== [dbo].[tr_Audit_GilinganProduksi_h] ON [dbo].[GilinganProduksi_h] ===== */
-- =============================================
-- TRIGGER: tr_Audit_GilinganProduksi_h
...
-- PK: {"NoProduksi":"..."}
-- =============================================
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_GilinganProduksi_h]
ON [dbo].[GilinganProduksi_h]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
