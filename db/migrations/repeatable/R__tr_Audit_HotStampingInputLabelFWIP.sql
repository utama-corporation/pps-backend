/* ===== [dbo].[tr_Audit_HotStampingInputLabelFWIP] ON [dbo].[HotStampingInputLabelFWIP] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_HotStampingInputLabelFWIP]
ON [dbo].[HotStampingInputLabelFWIP]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
