/* ===== [dbo].[tr_Audit_HotStampingOutputRejectV2] ON [dbo].[HotStampingOutputRejectV2] ===== */
-- =============================================
-- TRIGGER: tr_Audit_HotStampingOutputRejectV2
...
-- =============================================
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_HotStampingOutputRejectV2]
ON [dbo].[HotStampingOutputRejectV2]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
