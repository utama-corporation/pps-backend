/* ===== [dbo].[tr_Audit_InjectProduksiInputBroker] ON [dbo].[InjectProduksiInputBroker] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_InjectProduksiInputBroker]
ON [dbo].[InjectProduksiInputBroker]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
