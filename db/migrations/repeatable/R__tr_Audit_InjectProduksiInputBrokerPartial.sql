/* ===== [dbo].[tr_Audit_InjectProduksiInputBrokerPartial] ON [dbo].[InjectProduksiInputBrokerPartial] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_InjectProduksiInputBrokerPartial]
ON [dbo].[InjectProduksiInputBrokerPartial]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
