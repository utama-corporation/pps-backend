/* ===== [dbo].[tr_Audit_InjectProduksiInputFurnitureWIP] ON [dbo].[InjectProduksiInputFurnitureWIP] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_InjectProduksiInputFurnitureWIP]
ON [dbo].[InjectProduksiInputFurnitureWIP]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
