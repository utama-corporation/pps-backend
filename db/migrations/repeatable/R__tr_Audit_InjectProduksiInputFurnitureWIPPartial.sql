/* ===== [dbo].[tr_Audit_InjectProduksiInputFurnitureWIPPartial] ON [dbo].[InjectProduksiInputFurnitureWIPPartial] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_InjectProduksiInputFurnitureWIPPartial]
ON [dbo].[InjectProduksiInputFurnitureWIPPartial]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
