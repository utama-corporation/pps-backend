/* ===== [dbo].[tr_Audit_InjectProduksiInputMixerPartial] ON [dbo].[InjectProduksiInputMixerPartial] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_InjectProduksiInputMixerPartial]
ON [dbo].[InjectProduksiInputMixerPartial]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
