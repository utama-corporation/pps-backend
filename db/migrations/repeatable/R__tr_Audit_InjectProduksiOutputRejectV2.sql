/* ===== [dbo].[tr_Audit_InjectProduksiOutputRejectV2] ON [dbo].[InjectProduksiOutputRejectV2] ===== */
-- =============================================
-- TRIGGER: tr_Audit_InjectProduksiOutputRejectV2
...
-- =============================================
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_InjectProduksiOutputRejectV2]
ON [dbo].[InjectProduksiOutputRejectV2]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
