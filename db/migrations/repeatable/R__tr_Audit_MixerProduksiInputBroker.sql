/* ===== [dbo].[tr_Audit_MixerProduksiInputBroker] ON [dbo].[MixerProduksiInputBroker] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_MixerProduksiInputBroker]
ON [dbo].[MixerProduksiInputBroker]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
