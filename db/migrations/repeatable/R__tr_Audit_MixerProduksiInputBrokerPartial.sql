/* ===== [dbo].[tr_Audit_MixerProduksiInputBrokerPartial] ON [dbo].[MixerProduksiInputBrokerPartial] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_MixerProduksiInputBrokerPartial]
ON [dbo].[MixerProduksiInputBrokerPartial]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
