/* ===== [dbo].[tr_Audit_MixerProduksiInputGilingan] ON [dbo].[MixerProduksiInputGilingan] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_MixerProduksiInputGilingan]
ON [dbo].[MixerProduksiInputGilingan]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
