/* ===== [dbo].[tr_Audit_MixerProduksiInputGilinganPartial] ON [dbo].[MixerProduksiInputGilinganPartial] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_MixerProduksiInputGilinganPartial]
ON [dbo].[MixerProduksiInputGilinganPartial]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
