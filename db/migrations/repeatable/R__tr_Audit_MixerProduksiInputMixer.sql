/* ===== [dbo].[tr_Audit_MixerProduksiInputMixer] ON [dbo].[MixerProduksiInputMixer] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_MixerProduksiInputMixer]
ON [dbo].[MixerProduksiInputMixer]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
