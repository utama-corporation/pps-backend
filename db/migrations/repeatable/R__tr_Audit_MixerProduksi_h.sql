...
/* ===== [dbo].[tr_Audit_MixerProduksi_h] ON [dbo].[MixerProduksi_h] ===== */
-- =============================================
-- TRIGGER: tr_Audit_MixerProduksi_h
...
-- PK: {"NoProduksi":"..."}
-- =============================================
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_MixerProduksi_h]
ON [dbo].[MixerProduksi_h]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
    SET NOCOUNT ON;
