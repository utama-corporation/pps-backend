...
/* ===== [dbo].[tr_Audit_PasangKunciInputLabelFWIP] ON [dbo].[PasangKunciInputLabelFWIP] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_PasangKunciInputLabelFWIP]
ON [dbo].[PasangKunciInputLabelFWIP]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
