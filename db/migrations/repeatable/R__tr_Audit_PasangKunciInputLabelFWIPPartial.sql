...
/* ===== [dbo].[tr_Audit_PasangKunciInputLabelFWIPPartial] ON [dbo].[PasangKunciInputLabelFWIPPartial] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_PasangKunciInputLabelFWIPPartial]
ON [dbo].[PasangKunciInputLabelFWIPPartial]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
