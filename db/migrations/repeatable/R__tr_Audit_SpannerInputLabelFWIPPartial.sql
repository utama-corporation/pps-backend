...
/* ===== [dbo].[tr_Audit_SpannerInputLabelFWIPPartial] ON [dbo].[SpannerInputLabelFWIPPartial] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_SpannerInputLabelFWIPPartial]
ON [dbo].[SpannerInputLabelFWIPPartial]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
