/* ===== [dbo].[tr_Audit_SpannerOutputRejectV2] ON [dbo].[SpannerOutputRejectV2] ===== */
-- =============================================
-- TRIGGER: tr_Audit_SpannerOutputRejectV2
...
-- =============================================
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_SpannerOutputRejectV2]
ON [dbo].[SpannerOutputRejectV2]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
