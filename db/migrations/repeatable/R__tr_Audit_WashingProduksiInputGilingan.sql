/* ===== [dbo].[tr_Audit_WashingProduksiInputGilingan] ON [dbo].[WashingProduksiInputGilingan] =====
...
*/
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_WashingProduksiInputGilingan]
ON [dbo].[WashingProduksiInputGilingan]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
  SET NOCOUNT ON;
