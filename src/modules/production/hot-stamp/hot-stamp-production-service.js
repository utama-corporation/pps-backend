...
/**
 * Buka kunci produksi: IsComplete 1 -> 0. Kebalikan dari completeHotStampingProduksi.
 */
async function uncompleteHotStampingProduksi(noProduksi, ctx) {
  const no = String(noProduksi || "").trim();
